...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-AZK11lfJ.mjs");
...
var manifest = {
	"524c3352ad29d80e88879c8eb27181ed299e4c86095f1cb3dea0dde8d77b71e6": {
		functionName: "fetchProductBySlug_createServerFn_handler",
		importer: () => import("./shop-api-BOhEpYxT.mjs")
	},
	"f715c9e53e1bcf99fb58ba5ce4b72ca2d1aefe66aa84173718558d28eb575844": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BZNXqXZQ.mjs").then((n) => n.t),
